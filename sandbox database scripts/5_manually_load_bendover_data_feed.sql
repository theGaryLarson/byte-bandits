DELETE  
FROM `byte-bandits-sandbox`.`bendover_data_feed`;
INSERT INTO `byte-bandits-sandbox`.`bendover_data_feed`
(
	bendover_id,
	first_name,
	last_name,
